...
from administration_app.views import (
    ...
    doctor_gender_distribution,
    gender_nurse_distribution,
    gender_patient_distribution,
    administrator_form,
...
urlpatterns = [
    ...
    path(
        ...
        doctor_gender_distribution,
        name="doctor-gender-distribution",
    ),
    path("gender-nurse-distribution/", gender_nurse_distribution, name=""),
    path(
        "gender-patient-distribution/",
        gender_patient_distribution,
        name="gender-patient-distribution",
    ),
